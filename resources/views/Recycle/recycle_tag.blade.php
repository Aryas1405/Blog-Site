...
<div class="jumbotron">
<div class="row">
<a class="btn btn-success" href="{{route('categories.recycle')}}" style="margin-left:700px;">Deleted Categories()</a>
<a class="btn btn-success" href="{{route('blogs.recycle')}}" style="margin-left:10px;">Deleted Blogs()</a>
</div>
